      ...
      <div className="bg-[#0b1f10] w-full">
        <div className="mx-auto max-w-[1440px] flex flex-row items-center justify-between py-3 px-4 lg:px-8 text-[11px] font-medium">
          ...
          <div className="flex items-center gap-2 text-slate-300">
            ...
            <svg className="h-3.5 w-3.5 text-[#7cc043]" fill="currentColor" viewBox="0 0 24 24">
              <path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/>
            </svg>
            <a href="tel:0426204514" className="text-white hover:text-[#7cc043] transition-colors font-bold tracking-wide">
              0426 204 514
            </a>
          </div>
        </div>
