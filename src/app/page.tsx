        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-row flex-nowrap items-center justify-between gap-2 pt-6 border-t border-white/10 text-[10px] sm:text-xs lg:text-sm font-bold text-white font-heading w-full overflow-x-auto lg:overflow-visible">
                <div className="flex items-center gap-2.5 whitespace-nowrap flex-shrink-0 lg:pr-6 lg:border-r lg:border-white/20 last:border-0 last:pr-0">
