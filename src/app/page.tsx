...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 antialiased">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl leading-tight font-serif text-white">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-3xl bg-white p-8 text-slate-800 shadow-2xl border border-slate-100/80 relative">
                ...
                <h3 className="text-2xl font-extrabold text-emerald-950 tracking-tight font-serif">Request a Free On-Site Quote</h3>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl text-slate-900 font-serif">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-[#036829] transition-colors">Tree Removal</h3>
                ...
                <Link href="/services/tree-removal" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-[#036829] transition-colors">Stump Grinding</h3>
                ...
                <Link href="/services/stump-grinding" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-[#036829] transition-colors">Palm Tree Removal</h3>
                ...
                <Link href="/services/palm-tree-removal" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-[#036829] transition-colors">Pruning & Lopping</h3>
                ...
                <Link href="/services/tree-pruning-lopping" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <Link href="/services/arborist-reports" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-red-700 transition-colors">Emergency Work</h3>
                ...
                <Link href="/services/emergency-tree-removal" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-red-700 hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-[#036829] transition-colors">Wood Chipping</h3>
                ...
                <Link href="/services/wood-chipping-mulching" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group flex flex-col justify-between">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-[#036829] transition-colors">Block Clearing</h3>
                  <p className="text-slate-600 text-sm mt-2 leading-relaxed">Full subdivision and commercial block clearing services.</p>
                </div>
                <Link href="/services/land-clearing" className="mt-6 inline-flex items-center gap-1 text-sm font-bold text-[#036829] hover:underline">Read More →</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* NEW SECTION: Seamless 4-Step Process Timeline */}
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 relative">
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-200/50 shadow-sm relative group hover:border-[#036829] transition-all">
              <div className="absolute -top-6 left-8 h-12 w-12 rounded-2xl bg-[#036829] text-white flex items-center justify-center font-bold text-lg shadow-md">
                1
              </div>
              <h3 className="text-xl font-bold text-slate-900 mt-4">Free Initial Booking</h3>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-200/50 shadow-sm relative group hover:border-[#036829] transition-all">
              ...
              <h3 className="text-xl font-bold text-slate-900 mt-4">Transparent Pricing</h3>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-200/50 shadow-sm relative group hover:border-[#036829] transition-all">
              ...
              <h3 className="text-xl font-bold text-slate-900 mt-4">Precision Execution</h3>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-200/50 shadow-sm relative group hover:border-[#036829] transition-all">
              ...
              <h3 className="text-xl font-bold text-slate-900 mt-4">Zero-Mess Cleanup</h3>
      ...
      {/* Why Choose Us & Video Mockup Section */}
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-6 h-[400px] rounded-3xl overflow-hidden relative shadow-inner">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center text-slate-900">
                ...
                <h4 className="font-extrabold text-2xl text-emerald-950 font-serif">Greater Melbourne Coverage</h4>
                <p className="text-sm mt-2 text-slate-800 max-w-xs font-semibold">104+ target suburbs serviced with fast-response arborist teams.</p>
              </div>
            </div>
      ...
      <section className="relative py-28 bg-[#023313] text-white text-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 space-y-6">
          <h2 className="text-3xl font-extrabold sm:text-5xl font-serif">Reach out to Arbco Tree today!</h2>
      ...
      {/* Footer */}
      <footer className="bg-emerald-950 text-slate-300 py-16 border-t border-emerald-900/60">
